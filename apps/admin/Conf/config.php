	...
	'admin_menu'	=> array(
    	...
    	'content'	=> array(
    		L('PUBLIC_CONTENT_MANAGEMENT')			=>	array(
    			...
    			'试卷管理' => U('admin/Paper/index'),
    			'试卷文章管理' => U('admin/PaperArticle/index'),
    			'真题管理' => U('admin/PaperTest/index'),
    			'真题例句' => U('admin/Words/index'),
    			'试卷单词管理' => U('admin/Paper/sectionWords'),
    			'解析疑惑' => U('admin/PaperTest/confusion'),
    			'解析纠错' => U('admin/PaperTest/correct'),
    			'意见反馈' => U('admin/Paper/feedback'),
    			'文章分类' => U('admin/Article/category'),
    			'文章列表' => U('admin/Article/index'),
    			'铃铛广告' => U('admin/SatPublic/index'),
	    	),
    	),
    	'task'	=> array(
